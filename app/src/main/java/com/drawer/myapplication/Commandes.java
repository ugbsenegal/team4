...
public class Commandes extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image = findViewById(R.id.imageViewDescription);
        nomArticle = findViewById(R.id.textViewNom);
        price = findViewById(R.id.textViewPrix);
        description = findViewById(R.id.textViewDescription);
        commander = findViewById(R.id.btn_commander);
        Bundle bundle = getIntent().getExtras();


        //get the values parse
        String nom = bundle.getString("nom");
        Double prix = bundle.getDouble("price");
        int ressourceId = bundle.getInt("image");
        String descript = bundle.getString("description");

        //set our display
        nomArticle.setText(nom);
        price.setText(Double.toString(prix)+" CFA");
